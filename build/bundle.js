...
var Game = function () {
  function Game(element, width, height) {
    ...
    this.player1 = new _Paddle2.default(this.height, this.width / 2, this.paddleWidth, this.paddleHeight, this.boardGap, (this.height - this.paddleHeight) / 2, _settings.KEYS.w, _settings.KEYS.s, _settings.KEYS.a, _settings.KEYS.d, 'player1');

    this.player2 = new _Paddle2.default(this.height, this.width, this.paddleWidth, this.paddleHeight, this.width - this.boardGap - this.paddleWidth, (this.height - this.paddleHeight) / 2, _settings.KEYS.up, _settings.KEYS.down, _settings.KEYS.left, _settings.KEYS.right, 'player2');
...
var Board = function () {
  ...
  _createClass(Board, [{
    ...
    value: function render(svg) {
      ...
      rect.setAttributeNS(null, 'fill', '#00ced1');
      ...
      line.setAttributeNS(null, 'stroke', '#353535');
...
var Paddle = function () {
  function Paddle(boardHeight, boardWidth, width, height, x, y, up, down, left, right, playerName) {
    var _this = this;
  ...
  _createClass(Paddle, [{
    ...
    value: function render(svg) {
      ...
      var rectPad = document.createElementNS(_settings.SVG_NS, 'rect');
...
var Score = function () {
  ...
  _createClass(Score, [{
    ...
    value: function render(svg, score) {
      var scoreText = document.createElementNS(_settings.SVG_NS, 'text');
      ...
      scoreText.setAttributeNS(null, 'fill', 'teal');
